/**
 * ScrollArea primitive — thin wrapper around @radix-ui/react-scroll-area.
 * Replaces the native overflow-y-auto region in the activity feed so the
 * custom scrollbar matches the dashboard's premium light theme.
 */
